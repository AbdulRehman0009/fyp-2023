...
const NavBar: React.FC<IProps> = ({ isAuth, theme }) => {
  ...
  return hideNavToPaths.includes(pathname) ? null : (
    <>
      {isLaptop ? (
        <nav className="contain flex justify-between items-center z-9999 border-b border-gray-200 dark:border-gray-900 align-center w-100 bg-white text-gray-700 h-60px py-2 fixed w-full dark:bg-indigo-1000">
