  ...
  return (
    <ul className="flex items-center justify-between tablet:justify-evenly flex-wrap laptop:justify-start space-x-1 laptop:space-x-4 px-4 bg-indigo-100 dark:bg-indigo-1000 laptop:dark:bg-transparent laptop:bg-transparent laptop:p-0">
      <li>
        <Link
          ...
          className={`${linkStyleName} ${
            (activeNav === username || activeNav === "") &&
            "border-indigo-700 dark:border-indigo-400  border-b-4 text-gray-800 dark:text-white "
          }`}
        >
      ...
      <li>
        ...
        >
          <span className="laptop:text-lg text-indigo-700 dark:text-indigo-400">
            {followersCount}
          </span>
